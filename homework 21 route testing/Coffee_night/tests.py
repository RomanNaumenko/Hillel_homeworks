...
from Coffee_night.views import add_event, event_handler, route_add
        ...
        request = self.factory.post('/route/add_route', {"start_point": "Kiev", "destination_point": "Lviv",
                                                         "stop_points": [
                                                             ...
                                                             {"name": "ce7ddb39-748b-4d9f-afcc-923afab528ed",
                                                              ...
                                                              "lon": 0.9296349572111213}],
                                                         "country": "test_country",
                                                         "loc": "test_loc", "desc": "test_desc", "route_type": "CAMPING",
                                                         "duration": 3})
...
class TestEvent(TestCase):
    ...
    def test_with_user(self):
        request = self.factory.post('/route/1/add_event', {"event_date": "2022-11-14", "price": 1000})
        request.user = self.user
        response = add_event(request, route_id=1)
        self.assertEqual(200, response.status_code)
